export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Gridy",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Gridy has been downloaded, would you like to install it and relaunch?",
